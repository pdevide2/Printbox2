...
Public Class FrmPrintWMS
    ...
    Private Function GeraTextoNormalPrintWMS(ByVal _pedido As String, ByVal _caixa As String,
        ...
        sZebraText += "^LL0208"
        sZebraText += "^LS0"
        sZebraText += "^FT29,51^A0N,25,24^FH\^FDP: " & _pedido & "^FS"
        sZebraText += "^FT29,159^A0N,28,28^FH\^FD" & objProduto.Colecao & "^FS"
        sZebraText += "^FT29,122^A0N,23,24^FH\^FD" & objProduto.Linha & "^FS"
        sZebraText += "^FT29,90^A0N,28,28^FH\^FD" & objProduto.Griffe & "^FS"
        sZebraText += "^BY3,3,64^FT272,90^BCN,,Y,N"
        sZebraText += "^FD>;" & _caixa & "^FS"
        sZebraText += "^FT672,114^A0N,39,38^FH\^FDQTD. " & _qtde_total & "^FS"
        sZebraText += "^FT586,60^AAN,45,25^FH\^FD" & objFilial.CodigoRota & "-" & objFilial.SufixoFilial & "^FS"
        sZebraText += "^FT522,118^A0N,23,24^FH\^FD" & objProduto.Categoria & "^FS"
        sZebraText += "^FT365,160^A0N,34,33^FH\^FD" & objCaixa.NomeCliFor.PadLeft(25, " ") & "^FS"
        sZebraText += "^PQ1,0,1,Y^XZ"
